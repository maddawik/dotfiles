...
local mappings = {
  ...
  ["e"] = { "<cmd>NeoTreeFocusToggle<cr>", "Filetree" },
  ["o"] = { "<cmd>NeoTreeFocus<cr>", "Focus Filetree" },
  ...
  l = {
    ...
    s = { "<cmd>SymbolsOutline<cr>", "Symbol Map" },
  },

  f = {
    name = "Find",
    b = { "<cmd>Telescope git_branches theme=ivy<cr>", "Git branch" },
