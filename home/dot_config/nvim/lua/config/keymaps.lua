...
map("n", "<leader>sg", function()
  require("maddawik.pickers").grep_live()
end, { desc = "Grep" })
map("n", "<leader>sG", function()
  require("maddawik.pickers").grep_live({}, { source = { cwd = vim.fn.expand("%:p:h") } })
...
map("n", "<leader>sP", function()
  require("maddawik.pickers").files({}, { source = { cwd = vim.fn.expand("~") .. "/.local/share/nvim/lazy/" } })
